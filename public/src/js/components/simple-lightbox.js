...
$.fn.simpleLightbox = function( options )
{
	...
	var options = $.extend({
		...
		close:				true,
		closeText:			'<svg enable-background="new 0 0 32 32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" class="icon_close"><path d="m17.459 16.01l8.239-8.194c.395-.391.395-1.024 0-1.414-.394-.391-1.034-.391-1.428 0l-8.232 8.187-8.308-8.309c-.394-.395-1.034-.395-1.428 0-.394.396-.394 1.037 0 1.432l8.302 8.303-8.332 8.286c-.394.391-.394 1.024 0 1.414.394.391 1.034.391 1.428 0l8.325-8.279 8.275 8.276c.394.395 1.034.395 1.428 0 .394-.396.394-1.037 0-1.432l-8.269-8.27"></path></svg>',
		swipeClose:			true,
		showCounter:		true,
	...
	var touchDevice	= ( 'ontouchstart' in window ),
		...
		closeBtn = $('<div>').addClass('sl-close').html(options.closeText),
